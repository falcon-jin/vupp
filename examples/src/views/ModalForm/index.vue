<template>
<el-button type="primary" size="default" @click="openModal">编辑内容</el-button>
<v-modal-form 
...
>
  <template #footer="scope">
    ...
    <el-button type="primary" @click="confirm(scope)">Confirm</el-button>
  </template>
  <template #uploadArea>
...
const confirm = (scope: any) => {
  let validate = scope.form.validate() // 表单校验
  let modal = scope.form.getFormData() // 获取表单数据
