import { defineComponent, ref, watch, resolveComponent, openBlock, createElementBlock, createVNode, unref, isRef, withCtx, Fragment, renderList, createBlock } from "vue";
var libCity = [
  {
    code: "11",
    name: "\u5317\u4EAC\u5E02",
...
const _hoisted_1 = { class: "v-area-selector__wrapper" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    watch(() => province.value, (val) => {
      var _a;
      if (val) {
        selectCity.value = (_a = allCities.value.find((item) => item.code === province.value)) == null ? void 0 : _a.children;
      }
      city.value = "";
      area.value = "";
    });
    watch(() => city.value, (val) => {
      var _a;
      if (val) {
        selectArea.value = (_a = selectCity.value.find((item) => item.code === city.value)) == null ? void 0 : _a.children;
      }
      area.value = "";
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(_component_el_select, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(allCities), (item) => {
...
var vAreaSelector = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a7bc421a"]]);
var index = {
  install(app) {
