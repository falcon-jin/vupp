...
var n, l, u, t, o, r$1, f$1, e$1 = {}, c$1 = [], s = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function a$1(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
function m(n2) {
  (!n2.__d && (n2.__d = true) && t.push(n2) && !g$1.__r++ || r$1 !== l.debounceRendering) && ((r$1 = l.debounceRendering) || o)(g$1);
}
function g$1() {
  for (var n2; g$1.__r = t.length; )
    n2 = t.sort(function(n3, l2) {
      ...
      n3.__d && (o2 = (t2 = (l2 = n3).__v).__e, (r2 = l2.__P) && (u2 = [], (i2 = a$1({}, t2)).__v = t2.__v + 1, j$2(r2, t2, i2, l2.__n, r2.ownerSVGElement !== void 0, t2.__h != null ? [o2] : null, u2, o2 == null ? k(t2) : o2, t2.__h), z$1(u2, t2), t2.__e != o2 && b$1(t2)));
    });
}
...
function L$1(l2, u2, i2, t2, o2, r2, f2, c2) {
  ...
  if (d2 === null)
    ...
    if (C$1(l2, p2, y2, o2, c2), v2)
      u2.__k = [];
    else if (_2 = u2.props.children, w$1(l2, Array.isArray(_2) ? _2 : [_2], u2, i2, t2, o2 && d2 !== "foreignObject", r2, f2, r2 ? r2[0] : i2.__k && k(i2, 0), c2), r2 != null)
      for (_2 = r2.length; _2--; )
        r2[_2] != null && h(r2[_2]);
...
function S$1(u2, i2, t2) {
  var o2, r2, f2;
  l.__ && l.__(u2, i2), r2 = (o2 = typeof t2 == "function") ? null : t2 && t2.__k || i2.__k, f2 = [], j$2(i2, u2 = (!o2 && t2 || i2).__k = v$1(d, null, [u2]), r2 || e$1, e$1, i2.ownerSVGElement !== void 0, !o2 && t2 ? [t2] : r2 ? null : i2.firstChild ? n.call(i2.childNodes) : null, f2, !o2 && t2 ? t2 : r2 ? r2.__e : i2.firstChild, o2), z$1(f2, u2);
}
function D$1(n2, l2) {
...
n = c$1.slice, l = { __e: function(n2, l2, u2, i2) {
...
}, _.prototype.render = d, t = [], o = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, g$1.__r = 0, f$1 = 0;
...
l.unmount = function(n2) {
  var t2 = n2.__c;
  t2 && t2.__R && t2.__R(), t2 && n2.__h === true && (n2.type = null), A && A(n2);
...
function D(n2) {
  ...
  } }), S$1(v$1(j, { context: t2.context }, n2.__v), t2.l)) : t2.l && t2.componentWillUnmount();
}
function I(n2, t2) {
  return v$1(D, { __v: n2, i: t2 });
}
...
var index = {
  install(app) {
    app.component("v-calendar", _sfc_main);
  }
};
