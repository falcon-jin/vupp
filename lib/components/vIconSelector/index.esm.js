...
const ElBadge = withInstall(_sfc_main$2);
const messageConfig = {};
...
var MessageConstructor = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["render", _sfc_render]]);
const instances = [];
let seed = 1;
...
const _hoisted_1 = /* @__PURE__ */ createTextVNode("\u8BF7\u9009\u62E9\u56FE\u6807");
const _hoisted_2 = { class: "v-icon-selector__dialog-body--height" };
const _hoisted_3 = { class: "v-icon-selector__wrapper" };
const _hoisted_4 = ["onClick"];
const _hoisted_5 = { class: "v-icon-selector__text" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    const props = __props;
    let _dialogVisible = ref(props.visible);
    const handleClick = () => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createElementVNode("div", _hoisted_2, [
          createVNode(_component_el_dialog, {
            title: props.title,
            modelValue: unref(_dialogVisible),
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => isRef(_dialogVisible) ? _dialogVisible.value = $event : _dialogVisible = $event),
            onClose: handleClose
          }, {
            default: withCtx(() => [
              createElementVNode("div", _hoisted_3, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(unref(Icons)), (item, index2) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    key: index2,
                    onClick: ($event) => handleClickIcon(item)
                  }, [
...
var vIconSelector = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b2465520"]]);
var index = {
  install(app) {
