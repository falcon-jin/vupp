...
import { defineComponent, resolveComponent, openBlock, createElementBlock, createVNode, mergeProps, withCtx, Fragment, renderList, createBlock, resolveDynamicComponent, unref, createCommentVNode, createElementVNode, toDisplayString, createStaticVNode, useAttrs, isVNode } from "vue";
var MenuProps = {
  data: {
    type: Array,
    required: true
...
const _hoisted_1$4r = { class: "v-menu__wrapper" };
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$4r, [
        createVNode(_component_el_menu, mergeProps({
          router: _ctx.router,
          defaultActive: _ctx.defaultActive
        }, _ctx.$attrs), {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.data, (item, i) => {
              return openBlock(), createElementBlock(Fragment, { key: i }, [
                !item[_ctx.children] || !item[_ctx.children].length ? (openBlock(), createBlock(_component_el_menu_item, {
                  key: 0,
                  index: item[_ctx.index]
                }, {
                  default: withCtx(() => [
                    item[_ctx.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(item[_ctx.icon])}`), { key: 0 })) : createCommentVNode("", true),
                    createElementVNode("span", null, toDisplayString(item[_ctx.name]), 1)
                  ]),
                  _: 2
                }, 1032, ["index"])) : createCommentVNode("", true),
                item[_ctx.children] && item[_ctx.children].length ? (openBlock(), createBlock(_component_el_sub_menu, {
                  key: 1,
                  index: item[_ctx.index]
                }, {
                  title: withCtx(() => [
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(item[_ctx.children], (itemc, indey) => {
                      return openBlock(), createBlock(_component_el_menu_item, {
                        key: indey,
                        index: itemc[_ctx.index]
                      }, {
                        default: withCtx(() => [
                          itemc[_ctx.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(itemc[_ctx.icon])}`), { key: 0 })) : createCommentVNode("", true),
                          createElementVNode("span", null, toDisplayString(itemc[_ctx.name]), 1)
                        ]),
                        _: 2
                      }, 1032, ["index"]);
                    }), 128))
          ...
          _: 1
        }, 16, ["router", "defaultActive"])
      ]);
    };
  }
});
var vMenu = /* @__PURE__ */ _export_sfc$1(_sfc_main$4r, [["__scopeId", "data-v-1f5226ad"]]);
...
var vInfiniteMenu = defineComponent({
  props: MenuProps,
  setup(props, ctx) {
    let renderMenu = (data) => {
      return data.map((item) => {
        item.iconD = Icons[item[props.icon]];
        let slots = {
          title: () => {
            return createVNode(Fragment, null, [createVNode(item.iconD, null, null), createVNode("span", null, [item[props.name]])]);
          }
        };
        ...
        return createVNode(resolveComponent("el-menu-item"), {
          ...
          default: () => [createVNode(item.iconD, null, null), createVNode("span", null, [item[props.name]])]
        });
      });
    };
    let attrs = useAttrs();
    return () => {
      ...
      return createVNode("div", {
        "class": "v-infinite-menu__wrapper"
      }, [createVNode(resolveComponent("el-menu"), mergeProps({
